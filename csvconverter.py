...
#---
# straightly lifted from python documentation
...
if __name__ == '__main__':
    convert_json_csv('data/yelp_training_set_business.json')
    convert_json_csv('data/yelp_training_set_review.json')
    convert_json_csv('data/yelp_training_set_user.json')
    convert_json_csv('data/yelp_training_set_checkin.json')

    convert_json_csv('data/yelp_test_set_business.json')
    convert_json_csv('data/yelp_test_set_review.json')
    convert_json_csv('data/yelp_test_set_user.json')
    convert_json_csv('data/yelp_test_set_checkin.json')
